...
const SkeletonCard = () => {
  return (
    <div className="bg-white p-6 pt-7 rounded-[24px] border border-slate-100 shadow-sm flex flex-col h-[200px] animate-pulse">
      {/* Header/Title block */}
      ...
      {/* Small Badge block */}
      <div className="h-4 bg-slate-50 rounded-md w-1/4 mb-5"></div>
